...
=begin text
	...
	The latest version of this document is available at:
        http://www.tnpi.net/wiki/Logmonster_Changes
...
=head2 3.02 and higher

3.02+ changes are on the web site.

=begin html

<a href="http://www.tnpi.net/wiki/Logmonster_Changes">http://www.tnpi.net/wiki/Logmonster_Changes</a>
...
=item * updated usage examples

=item * added FAQ

=item * updated META.yml to new format

=item * email report formatting 
...
=item * added inc/Module/Install

=item * added Build.PL

=item * added examples/daily_email_report.txt
