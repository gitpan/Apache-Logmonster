...
# basic OO mechanism
my $utility = Apache::Logmonster::Utility->new;    # create an object
ok( defined $utility, 'get Apache::Logmonster::Utility object' );    # check it
isa_ok( $utility, 'Apache::Logmonster::Utility' );    # is it the right class
